...
def main():
    ...
    if 'gov_report' in args.data_dir:
        ...
        generate_args = dict(beam=4, max_len_b=350, lenpen=4.0, no_repeat_ngram_size=3, min_len=50)
    ...
    print(f'Rouge results: R-1 {rouge1 / len(all_results)}, R-2 {rouge2 / len(all_results)}, R-L {rougel / len(all_results)} ')
