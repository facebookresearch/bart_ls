...
python fb_sweep/long_finetune/sweep_summ.py -p pubmed_large_all \
-d /fsx/xwhan/data/pubmed-dataset-bin \
-g 8 -n 2 -t 1 --partition hipri --checkpoints-dir /fsx/xwhan/checkpoints/pubmed --resume-failed --snapshot-code \
--baseline-model /fsx/xwhan/checkpoints/long_denoising/t5_all_corpus.bart_large.faststatsync.pool4.block_noglobal.ms16384.mt1024.uf1.mu500000.brk_complete.dr0.1.atdr0.1.actdr0.0.wd0.01.bsz4.adam.eps1e-06.clip0.1.s42.lr0.0001.warm500.memfp16.noise0.0625.dynaspan.ngpu128/model_100k.pt --no-wandb --local


python fb_sweep/long_finetune/sweep_summ.py -p arxiv_large_all \
-d /fsx/xwhan/data/arxiv-dataset-bin \
-g 8 -n 2 -t 1 --partition hipri --checkpoints-dir /fsx/xwhan/checkpoints/arxiv --resume-failed --snapshot-code \
 --baseline-model /fsx/xwhan/checkpoints/long_denoising/t5_all_corpus.bart_large.faststatsync.pool4.block_noglobal.ms16384.mt1024.uf1.mu500000.brk_complete.dr0.1.atdr0.1.actdr0.0.wd0.01.bsz4.adam.eps1e-06.clip0.1.s42.lr0.0001.warm500.memfp16.noise0.0625.dynaspan.ngpu128/model_100k.pt --no-wandb --local


python fb_sweep/long_finetune/sweep_summ.py -p gov_large_all \
-d /fsx/xwhan/data//gov_report-bin \
-g 8 -n 2 -t -1 --partition lowpri --checkpoints-dir /fsx/xwhan/checkpoints/gov --resume-failed --snapshot-code \
    --baseline-model /fsx/xwhan/checkpoints/long_denoising/t5_all_corpus.bart_large.faststatsync.pool4.block_noglobal.ms16384.mt1024.uf1.mu500000.brk_complete.dr0.1.atdr0.1.actdr0.0.wd0.01.bsz4.adam.eps1e-06.clip0.1.s42.lr0.0001.warm500.memfp16.noise0.0625.dynaspan.ngpu128/model_100k.pt --no-wandb --time 600

python fb_sweep/long_finetune/sweep_summ.py -p tvm_large_all \
-d /fsx/xwhan/data/summscreen/tv-bin \
-g 8 -n 2 -t -1 --partition hipri --checkpoints-dir /fsx/xwhan/checkpoints/tvm --resume-failed --snapshot-code \
    --baseline-model /fsx/xwhan/checkpoints/long_denoising/t5_all_corpus.bart_large.faststatsync.pool4.block_noglobal.ms16384.mt1024.uf1.mu500000.brk_complete.dr0.1.atdr0.1.actdr0.0.wd0.01.bsz4.adam.eps1e-06.clip0.1.s42.lr0.0001.warm500.memfp16.noise0.0625.dynaspan.ngpu128/model_100k.pt --no-wandb --local

python fb_sweep/long_finetune/sweep_summ.py -p bsum_large_all \
-d /fsx/xwhan/data/booksum-chapters-bin \
-g 8 -n 1 -t -1 --partition a100 --checkpoints-dir /fsx/xwhan/checkpoints/bsum --resume-failed --snapshot-code \
    --baseline-model /fsx/xwhan/checkpoints/long_denoising/t5_all_corpus.bart_large.faststatsync.pool4.block_noglobal.ms16384.mt1024.uf1.mu500000.brk_complete.dr0.1.atdr0.1.actdr0.0.wd0.01.bsz4.adam.eps1e-06.clip0.1.s42.lr0.0001.warm500.memfp16.noise0.0625.dynaspan.ngpu128/model_100k.pt --no-wandb --local
"""
