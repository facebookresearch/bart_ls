...
# assembled shards on /fsx
# prefix = '/fsx/xwhan/data/pretrain_corpus/pretrain_regimes/assembled_c4_10shards'

# assembled corpus with top2k
# prefix = '/fsx/xwhan/data/pretrain_corpus/pretrain_regimes/assembled_c4_top2k'

# corpus without C4
# prefix = '/fsx/xwhan/data/pretrain_corpus/pretrain_regimes/books3_stories_bookwiki_realnews_dialogue_10shards'

# original c4 data
# prefix = '/fsx/xwhan/data/pretrain_corpus/pretrain_regimes/c4_10shards'


# long docs assembled via 2-level clustering, the connections might be weak
# prefix = '/fsx/xwhan/data/pretrain_corpus/pretrain_regimes/cluster_c4_10shards'
